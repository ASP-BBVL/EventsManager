    ...
    public partial class PInitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Activities", t => t.ActivityCategory, cascadeDelete: true)
                .Index(t => t.ActivityCategory);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Events", "ActivityCategory", "dbo.Activities");
            ...
            DropIndex("dbo.Events", new[] { "ActivityCategory" });
